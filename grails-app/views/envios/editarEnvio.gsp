            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input value="${envio.nombreRemitente}" type="text" id="remitente" name="remitente" required class="form-control"  data-validation="length" data-validation-length="2-25" >
                    </div>

                    <div class="form-group">
                        <label for="telefono_remitente">Telephone de l'expediteur</label>
                        <input  value="${envio.telefonoRemitente}" type="text" id="telefono_remitente" name="telefono_remitente" class="form-control" data-validation-optional="true" data-validation="length" data-validation-length="2-25">
                    </div>

                    <div class="form-group">
                        <label for="destinatario">Destinataire</label>
                        <input value="${envio.nombreDestinatario}"  type="text" id="destinatario"   name="destinatario" class="form-control" data-validation="length" data-validation-length="2-25">
                        <div id="somehiddendiv"></div>
                    </div>

                    <div class="form-group">
                        <label for="telefonoDestinatario">Telephone du Destinataire</label>
                        <input value="${envio.telefonoDestinatario}" type="text" id="telefonoDestinatario" name="telefonoDestinatario" class="form-control" data-validation="length" data-validation-length="2-25">
                    </div>

                    <div class="form-group">
                        <label>Détails supplémentaires</label>
                        <div class="input-group">
                            <textarea id="detalles_adicionales" name="detallesAdicionales" class="form-control" cols="93" rows="5" placeholder="Espace disponible pour ecrire n'importe quelle detalle.">${envio.detallesAdicionales}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input value="${envio.nombrePaquete}"  type="text" id="nombre_paquete"   name="nombre_paquete" class="form-control" data-validation="length" data-validation-length="2-25">
                        %{--<div id="somehiddendiv"></div>--}%
                    </div>

                    <div class="form-group">
                        <label for="precioPaquete">Prix du colis</label>
                        <input value="${envio.precioPaquete}" type="text" id="precioPaquete" name="precioPaquete" class="form-control" data-validation="length" data-validation-length="2-25">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input value="${envio.pesoPaquete}" type="text" name="peso_paquete" id="peso_paquete" class="form-control" data-validaton="length" data-validation="2-25">
                        </div>
                    </div>
                    ...
                    <input id="punto_origin_id" type="hidden" value="${envio.puntoOrigin.nombre}">
                    <input id="punto_destino_id" type="hidden" value="${envio.puntoDestino.nombre}">
                    <input id="conValor_id" type="hidden" value="${envio.conValor}">
                    ...
                    <div class="form-group">
                        ...
                        <input value="${envio.precioPaquete}" type="text" id="precio_envio" name="precio_envio" class="form-control" data-validation="length" data-validation-length="2-25">
                    </div>
...
<script>
//    $(document).ready(function () {
        let puntoOrigin=$("#punto_origin_id").val()
        let puntoDestino=$("#punto_destino_id").val()
        let conValor=$("#conValor_id").val()



        if(conValor==="true"){
            $("#conValor").prop("checked",true)
            $("#precio_envio_v").css("display", "");
            $("#precio_envio_").css("display","None")

        }else {
            $("#conValor").prop("checked",false)
