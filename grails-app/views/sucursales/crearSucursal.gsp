...
<section style="margin-top: 2%;margin-right: 2%;margin-left: 2%">
    <div class="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <g:form action="procesarSucursal">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="direccion">Addresse</label>
                            <input placeholder="Address Complete" type="text" id="direccion" name="direccion" class="form-control" data-validation="strength" data-validation-strength="1">
                        </div>
                    </div>

                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="ciudad">Ville</label>
                                <input placeholder="Ville" type="text" id="ciudad" name="ciudad" class="form-control">
                            </div>
                ...
                <button type="summit" id="guardar" class="btn btn-block btn-success btn-sm">SAUVEGARDER</button>
